...
> **_NOTE:_**  Quarkus now ships with a Dev UI, which is available in dev mode only at <http://localhost:8001/q/dev/>.
...
You can then execute your native executable with: `./target/budget_tracker_backend-1.0-SNAPSHOT-runner`
